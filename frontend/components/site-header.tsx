...
import { MainNavigationMenu } from './site-navigation'
      ...
      <>
         <header className="animate-fade-in fixed left-0 top-0 z-50 w-full -translate-y-4 border-b opacity-0 backdrop-blur-md [--animation-delay:600ms]">
            <div className="container flex h-14 items-center justify-between">
               ...
               <div className="ml-auto h-full items-center pl-32 hidden md:flex">
                  <MainNavigationMenu />
               </div>
         ...
         <ScrollProgress className="top-[54px]" />
      </>
   )
}
